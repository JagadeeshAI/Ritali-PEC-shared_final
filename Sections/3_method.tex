...
Given a natural language instruction, PEC-Nav extracts a structured navigation goal, explores using a self-calibrating frontier search, stores observations in episodic memory, and answers follow-up questions from that memory. Figure~\ref{fig:architecture} gives an overview.
