...
On LMEE-Benchmark dataset official 58-task subset~\cite{wang2026memoryexplorer}, using GPT-4o for goal extraction and search reasoning and Qwen2.5-VL-7B for memory-based question answering, PEC-Nav reaches 24.45\% SR, 16.86 SPL, 57.93 MLLM-Score and 66.21\% QA accuracy.
